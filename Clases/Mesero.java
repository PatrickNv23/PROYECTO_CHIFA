package Clases;
public class Mesero extends Empleado implements Sueldoadicional{
    private double Sueldo;
    private int horas_extra;
    //
    public Mesero() {
    }
    public Mesero(String nombre, int codigo_empleado, String genero, int num_horasdia) {
    ...
    public void calcularSueldo() {
        ...
        System.out.println("El sueldo mensual para el mesero " + nombre + " es de : " + Sueldo);
    }
    @Override
    public void calcularSueldoHorasExtra() {
        double nuevo_precio = Sueldo + (horas_extra * precio_hora * valor);
        System.out.println("El sueldo más horas extras para el mesero " + nombre + " es : S/. " + nuevo_precio);
    }
}
